...
import HealthcareAssistant from "./pages/HealthcareAssistant";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/dietary-recommendations" element={<DietaryRecommendations />} />
          <Route path="/fitness-recommendations" element={<FitnessRecommendations />} />
          <Route path="/healthcare-assistant" element={<HealthcareAssistant />} />
